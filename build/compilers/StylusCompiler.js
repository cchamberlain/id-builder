...
var StylusCompiler = (function (_Compiler) {
  _inherits(StylusCompiler, _Compiler);

  function StylusCompiler() {
    _classCallCheck(this, StylusCompiler);

    _get(Object.getPrototypeOf(StylusCompiler.prototype), 'constructor', this).apply(this, arguments);
  }
  ...
  _createClass(StylusCompiler, [{
    ...
    value: function compileChunk(chunk) {
      ...
      return new Promise(function (resolve, reject) {
        (0, _stylus.render)(chunk, _this.options.options, function (e, result) {
          if (e) {
            return reject(e);
          }
