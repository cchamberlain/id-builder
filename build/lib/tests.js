...
var fs, idDebug, os, path, preludeLs, child_process, fileSystem, logging, debug, info, warning, error, each, pathToMocha, globalOptions, randomString, sourceFilePathMatches, runTest, runTests, out$ = typeof exports != 'undefined' && exports || this;
fs = require('fs');
