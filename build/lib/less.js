...
var less, async, idDebug, debug, error, info, warning, fileSystem, logging, sourceExtension, targetExtension, sourceFilePathMatches, compileChunk, compileFile, compileAllFiles, out$ = typeof exports != 'undefined' && exports || this;
less = require('less');
async = require('async');
