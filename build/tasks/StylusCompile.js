...
var StylusCompile = (function (_CompileTask) {
  ...
  _createClass(StylusCompile, [{
    ...
    value: function compileChunk(chunk, cb) {
      (0, _stylus.render)(chunk, this.options.options, cb);
    }
  }, {
    key: 'compileFile',
    value: function compileFile(sourceFilePath, targetFilePath, cb) {
      ...
      (0, _fs.exists)(sourceFilePath, function (doesExist) {
        if (doesExist) {
          _get(Object.getPrototypeOf(StylusCompile.prototype), 'compileFile', _this).call(_this, sourceFilePath, targetFilePath, cb);
        } else {
