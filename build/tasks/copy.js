...
var fs, mkdirp, async, lsr, ref$, map, filter, file, sourceFilePathMatches, copyFile, copyAllFiles, out$ = typeof exports != 'undefined' && exports || this;
fs = require('fs');
...
out$.copyAllFiles = copyAllFiles = curry$(function(options, task, cb){
  ...
  lsr(task.sourcePath, function(error, nodes){
    ...
    paths = filter(function(it){
      return !it.match(/\.(styl|less|ls|coffee|jade)$/);
    })(
    map(function(it){
      return it.fullPath;
    })(
