...
var CoffeeScriptCompile = (function (_CompileTask) {
  ...
  function CoffeeScriptCompile() {
    ...
    _get(Object.getPrototypeOf(CoffeeScriptCompile.prototype), 'constructor', this).apply(this, arguments);
  }
  ...
  _createClass(CoffeeScriptCompile, [{
    ...
    value: function compileChunk(chunk, cb) {
      try {
        cb(null, (0, _coffeeScript.compile)(chunk, this.options.options));
      } catch (e) {
        return cb(e);
      }
    }
