...
var idDebug, servers, watch, debug, dependencies, handlePath, handleAdd, handleAddDir, handleChange, handleUnlink, handleUnlinkDir, handleError, run, out$ = typeof exports != 'undefined' && exports || this;
...
handlePath = curry$(function(options, path, stat){
  ...
  servers.restartServers(options, function(error){
    if (error) {
      idDebug.error(error);
    }
  });
