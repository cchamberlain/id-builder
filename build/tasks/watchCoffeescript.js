...
var coffeescript, watch, dependencies, handlePath, handleAdd, handleAddDir, handleChange, handleUnlink, handleUnlinkDir, handleError, run, out$ = typeof exports != 'undefined' && exports || this;
...
handlePath = curry$(function(options, path, stat){
  ...
  coffeescript.compileFile(options, task, path, targetPath, function(e){
    if (e) {
      console.error(e);
    }
  });
