...
var LessCompile = (function (_CompileTask) {
  _inherits(LessCompile, _CompileTask);

  function LessCompile() {
    var options = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];

    _classCallCheck(this, LessCompile);

    _get(Object.getPrototypeOf(LessCompile.prototype), 'constructor', this).call(this, options);

    this.sourceFilePath = options.sourceFilePath;
    this.targetFilePath = options.targetFilePath;
  }

  _createClass(LessCompile, [{
    key: 'compileChunk',
    value: function compileChunk(chunk, cb) {
      (0, _less.render)(chunk, this.options.options, function (e, result) {
        if (e) {
          return cb(e);
        }
    ...
    value: function compileFile(sourceFilePath, targetFilePath, cb) {
      ...
      (0, _fs.exists)(sourceFilePath, function (doesExist) {
        if (doesExist) {
          _get(Object.getPrototypeOf(LessCompile.prototype), 'compileFile', _this).call(_this, sourceFilePath, targetFilePath, cb);
        } else {
