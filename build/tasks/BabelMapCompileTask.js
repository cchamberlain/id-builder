...
var BabelMapCompileTask = (function (_CompileTask) {
  _inherits(BabelMapCompileTask, _CompileTask);

  function BabelMapCompileTask() {
    var options = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];

    _classCallCheck(this, BabelMapCompileTask);
  ...
  return BabelMapCompileTask;
})(_libCompileTask2['default']);

exports['default'] = BabelMapCompileTask;
