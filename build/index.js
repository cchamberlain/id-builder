...
var async, idDebug, idType, path, preludeLs, moment, debug, info, warning, error, each, keys, fold1, defaultOptions, logging, parseOptions, logInfo, runTaskWithOptions;
async = require('async');
